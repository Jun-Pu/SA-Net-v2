...
#parser.add_argument('--load', type=str, default=os.getcwd() + '/checkpoints/CMANet_checkpoint.pth', help='train from checkpoints')
...
parser.add_argument('--save_path', type=str, default=os.getcwd() + '/SANetV2_LFSOD_cpts/', help='the path to save models and logs')
